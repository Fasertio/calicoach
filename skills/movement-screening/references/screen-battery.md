...
Self-administered. Give one test per message block: setup, movement, what to
watch, pass criterion. Always ask for both sides. Stop at first pain — the pain
is the finding.

Score each item **Pass / Limited / Symptomatic**, plus L/R where relevant.
...
- **Move:** arms straight, thumbs up, raise overhead trying to touch the backs of
  the hands to the wall.
- **Watch:** ribs flaring, low back lifting off the wall, elbows bending.
- **Pass:** both hands touch the wall with the low back still flat and elbows
  straight.
- **Limited:** hands short of the wall, or contact only by arching.
- **Common meaning:** lat/pec stiffness, thoracic extension deficit, or poor
  scapular upward rotation. All are trainable; none justify forcing an overhead
  press.
...
- **Pass:** visible controlled range, 5 clean reps, no shrugging, no pain.
- **Limited:** cannot dissociate scapular movement from elbow bend, or < 2 cm of
  travel. **Consequence: scapular work is a program priority before any
  straight-arm skill.**
...
- **Symptomatic:** front-of-shoulder pain -> no dips; substitute push-ups and
  see [injury-prevention](../../injury-prevention/SKILL.md).
...
- **Symptomatic:** pain at lockout -> **all straight-arm work is contraindicated
...
- **Watch:** ache or pinch at the inner elbow, the front of the elbow, or the
  biceps insertion.
- **Pass:** no symptoms during or in the 24 h after.
- **Symptomatic:** the single most important stop signal in calisthenics.
...
- **Limited:** < 70°, or pain in the front support position. **Consequence:**
...
- **Watch:** heels lifting, knees collapsing inward, torso folding forward, back
  rounding at the bottom (butt wink), asymmetric shift to one side.
- **Pass:** hip crease below knee, heels down, torso reasonably upright, no pain.
- **Limited:** any of the above compensations without pain.
- **Symptomatic:** knee, hip or back pain at any depth -> **program only to the
  pain-free depth.**
...
- **Limited:** < 8 cm, or > 2 cm asymmetry. **Consequence:** heel elevation for
...
- **Move:** slowly lower until the free heel taps the floor; 5 reps per side,
  3 s down.
- **Watch:** knee collapsing inward, hip dropping on the free side, trunk
  leaning, foot rolling in.
- **Pass:** 5 controlled reps per side, knee tracks over the second toe, level
  pelvis, no pain.
- **Symptomatic:** anterior knee pain -> reduce range to pain-free, no jumping,
...
- **Pass:** torso to ~parallel with contact maintained, hamstring stretch felt,
  no back pain.
- **Limited:** loses contact early — hinge range is programmed short (rack pull,
...
- **Limited:** < 60°, or marked asymmetry.
...
- **Limited:** < 20 s, or the low back lifts. **Consequence:** anti-extension
...
- **Note only** — feeds warm-up and bracing coaching.
...
1. Little finger bends back beyond 90° (L, R)
2. Thumb touches the forearm (L, R)
3. Elbow hyperextends beyond 10° (L, R)
4. Knee hyperextends beyond 10° (L, R)
5. Palms flat on the floor with straight knees (1 point)

**Interpretation:** 5+ (adults) suggests generalised hypermobility.

**Consequence for programming:** never load or hold passive end-range positions;
avoid hyperextending elbows and knees in support and lock-out positions (cue
"soft lock"); prioritise strength through range and control; slow every skill
progression; expect longer tissue-tolerance timelines; more warm-up. Refer if
there are systemic symptoms (frequent subluxations, chronic widespread pain,
autonomic symptoms).

---

## F. Optional load-tolerance probes

Run only if sections A–D are clean for the relevant region. These tell you where
to *start*, not what someone's maximum is.

| Probe | Purpose | Stop rule |
|---|---|---|
| 30 s dead hang | shoulder + grip tissue tolerance | any shoulder pain |
| 5 slow eccentric pull-ups (5 s) | pull tissue tolerance | elbow or shoulder symptoms |
| 20 s plank-to-lean progression | straight-arm tolerance | any elbow ache |
| 10 slow push-ups, 3 s down | press tolerance and shoulder position | front-shoulder pain |
| 60 s wall sit | knee tolerance | anterior knee pain |
| 10 slow box step-downs per side | knee + hip control under fatigue | knee pain or valgus collapse |

---

## Recording

For every item record: `Item | L | R | Result | Notes | Re-test date`.

Then produce the copy-ready `Active constraints` block for the program header —
see [contraindications.md](contraindications.md) and
